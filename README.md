...
2. Separate the template from source facts.
3. Parse the template structure and formatting style.
4. Extract source material from images, text notes, or a generation brief.
5. Extract facts, decisions, risks, metrics, next actions, and support needs.
6. Apply user corrections as the highest-priority facts.
7. Map extracted items only to template sections.
8. Rewrite rough notes into report language when needed.
9. Produce a report draft.
10. Add confirmation items when needed.
11. Ask the user to confirm or micro-edit.
12. Produce the final report after confirmation.
